...
functional components don't have to have state to work or don't need to contain state for them to be used - usually used to just render something on an app/site.
Stateful components are those that contain and handle state and its changes, usually data change via user interaction

2. When does a componentWillMount function be called? What about a componentWillUpdate?

the function componentWillMount will be called at the end of the Birth phase of a component lifecycle - meaning after it is done rendering on page.

A componentWillUpdate function is called when state or prop changes inside a component causing it to re-render. This occurs during the "growth" phase of a component's lifecycle - the middle part between being mounted (being born) and being unmounted(dying out of app/page)

3. Define stateful logic.

  any code that allows you to create and modifies state,function that set state behind the scenes (non-visually)

4. What are the three step of creating a successful test? What is done in each phase?

the 3 steps of creating a successful test, in order 
1)Arrange: sets up or renders the react component we are going to be testing
2)Act: declares what part of the component we are working with, whether thats an element and/or event related to that particular element
3)Assert: Verify that the element is doing what we expect it to 